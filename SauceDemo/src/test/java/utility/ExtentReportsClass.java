...
public class ExtentReportsClass extends Base{
	...
	public void startReport(){
		...
		extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/SauceDemoReport.html", true);
		//extent.addSystemInfo("Environment","Environment Name")
		extent
                .addSystemInfo("Host Name", "SauceServer")
                .addSystemInfo("Environment", "Automation Testing")
                .addSystemInfo("User Name", "Vishal");
